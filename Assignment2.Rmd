...
d_ric <- data.frame(teacher = "riccardo", grid = p_grid, posterior = posterior_ric, prior = prior3, likelihood = likelihood_riccardo)
d_kri <- data.frame(teacher = "kristian", grid = p_grid, posterior = posterior_kri, prior = prior3, likelihood = likelihood_kristian)
d_jos <- data.frame(teacher = "josh", grid = p_grid, posterior = posterior_jos, prior = prior3, likelihood = likelihood_josh)
d_mik <- data.frame(teacher = "mikkel", grid = p_grid, posterior = posterior_mik, prior = prior3, likelihood = likelihood_mikkel)
d <- rbind(d_ric,d_kri)
dd <- rbind(d_jos,d_mik)
d <- rbind(d,dd)
